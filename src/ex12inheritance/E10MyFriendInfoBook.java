...
class Friend {
	...
	String adrr;  //주소
	//생성자
	public Friend(String name, String phone, String adrr) {
		this.name =name;
		this.phone =phone;
		this.adrr =adrr;
	}
...
class HighFriend extends Friend{
	...
	public HighFriend(String name, String phone, String adrr, String nickname)
	{
		//부모클래스의 생성자 호출
		super(name, phone, adrr);
		//자신의 멤버변수 초기화 
...
class UnivFriend extends Friend{
	...
	public UnivFriend(String name, String phone, String adrr, String major)
	{
		super(name, phone, adrr);
		this.major = major;
	}
...
class FriendInfoHandler
{
	...
	3.정보 출력시 배열에 입력된 객체수만큼 반복하면서 각 요소를 통해
		멤버메서드를 호출한다.
	4.이때 오버라이딩 된 메서드를 통해 항상 해당 객체의 정보를 출력할 수 있는데,
		참조변수의 타입에 영향을 받지 않고 항상 오버라이딩 된 최하위의 메소드가
		호출되기 때문이다.
...
public class E10MyFriendInfoBook
{
	...
	/*
	프로그램 전반의 흐름에 대해서만 기술하고 관련메서드를 
	호출하는 정도로만 구성한다.
	main 메서드는 단지 프로그램의 시작점(Entry Point) 정도의 의미만
	가지는게 좋다.
	 */
	public static void main(String[] args)
	{
		...
		while(true) {
			...
			case 1: case 2:
				...
				break; // break문을 만나면 while문이 아닌 switch 문을 탈출한다.
			case 3:
				//전체정보출력
