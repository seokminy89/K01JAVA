...
class Child extends Parent{
	...
	void parentMethod()
	{
		System.out.println("자식에서 Overrriding한 메소드"+"parentMethod()");
	}
	//오버로딩된 메서드(확장한 메서드)(위와 이름은 같지만 매개변수가 있기 때문에)
...
public class E11Polymorphism
{
	...
	public static void main(String[] args)
	{
		...
		//parent1.childMember = 접근불가 ->부모타입으로 자식 멤버에 접근할 수 없다.
