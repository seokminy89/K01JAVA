...
public class E02StringMethod
{
	...
	public static void main(String[] args)
	{
		...
		/*
		3] codePointAt(인덱스) :문자열의 특정 인덱스의 문자를 찾은 후, 
			아스키코드(유니코드)를 반환한다.
		 */
		...
		/*
		7] endsWith()
			:특정문자열로 끝나면 true를 반환한다.
		8] startsWith()
			:특정문자열로 시작되면 true를 반환한다.
		 */
		...
		/*
		11] lastIndexOf()
		:사용법은 indexOf와 동일하나 문자열의 뒤에서부터 찾는다는 점이 다르다.
		 */
		...
		System.out.println(str1.replace("J", "G"));// 소문자 대문자가 달라서 변화x
		...
		/*
		14] substring()
			:시작 인덱스와 끝 인덱스 사이의 문자열을 잘라서 반환해준다.
