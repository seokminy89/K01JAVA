...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		 시나리오] 1~100가지의 합을 구하는 프로그램을 for문을
		    이용하여 작성하시오.
		 */
		int sum = 0;
...
//		for 문의 끝에 ;을 사용하면 반복할 문장이 없는 것으로 간주되어
//	    for 문과 상관없이 한번만 실행된다.
		...
		System.out.println("위 main함수 지역에서 선언한 변수total="+
		total);
		
		/*
		for 문의 초기값을 외부(넓은지역)에서 선언하면 해당변수는 for문의
