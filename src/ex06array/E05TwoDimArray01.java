...
public class E05TwoDimArray01
{
	...
	{
		/*
		아래와 같이 2차원 배열을 초기화 하면 세로 3, 가로4인 배열이
		생성된다.
		초기화 할 요소가 없는 부분은 null로 채워진다.
		※null값 : 아무것도 없는 값을 일컫는다. 즉 빈값을 말한다.
		스페이스와 같은 공백문자, 혹은 0(아스키 코드로 값이 있음.) 과는 
		다르다는것에 주의하자.
		 */
		...
		/*
		ArrayIndexOutOfBounds 예외가 발생된다.
