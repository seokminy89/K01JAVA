...
public class E05DateCalender1
{
	...
	public static String myDateFormat(Calendar c, String formatStr) {
		Date date = c.getTime();// 1970 1월 1일부터 지금까지의 시간을 초로 반환
		return new SimpleDateFormat(formatStr).format(date);
	}
	/*
	특정 날짜를 지정하여 남은 날짜를 계산하여 반환하는 메서드.
	여러개의 값을 반환하고 싶을대는 배열을 이용할 수 있다.
	 */
	public static String[] myDiffDate() throws ParseException{
		...
		1~10까지는 순수한 초이고, 11~13까지는 밀리세컨즈를 의미한다.
		즉 1000으로 나눠서 뒷부분의 밀리세컨즈값 3자리를 제거하면
		순수한 초가 반환된다.
		 */
	...
	public static void main(String[] args) throws ParseException
	{
		...
		System.out.println(myDateFormat(calendar, "오늘은 M월의 W번재주, d번째날, F번째 E요일"));
