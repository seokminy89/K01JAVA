...
public class E01AccessModifierMain
{
	...
	public static void main(String[] args)
	{
		...
		/*
		-동일한 패키지에 선언되었으므로 import 없이 객체를 생성할 수 있다.
		...
		one.publicMethod();
		/*
		private으로 선언된 멤버에 외부클래스에서 접근하려면 pulic으로
		...
		/*
		다른 패키지에 선언된 클래스이므로 객체 생성을 위해 import 선언을
		...
		/*
	 	다른 패키지에 선언된 디폴트 클래스 이므로 객체 생성이 불가능하다.
